...
public class SpringSecurity {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/main/main", "/client/**").hasRole("CLIENT")
                .requestMatchers("/main/main", "/client/**", "/manager/**").hasRole("MANAGER")
                .requestMatchers("/main/main", "/client/**", "/manager/**", "/admin/**").hasRole("ADMIN")
                .and()
